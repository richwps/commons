 ...
 * <ul>
 *   <li>{@link de.hsos.richwps.dSL.VAR_REFERENCE#getRefname <em>Refname</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.hsos.richwps.dSL.DSLPackage#getVAR_REFERENCE()
 * @model
 * @generated
 */
public interface VAR_REFERENCE extends EObject
{
  /**
   ...
   * @see de.hsos.richwps.dSL.DSLPackage#getVAR_REFERENCE_Refname()
   * @model
   * @generated
   */
  String getRefname();
  ...
  /**
   * Sets the value of the '{@link de.hsos.richwps.dSL.VAR_REFERENCE#getRefname <em>Refname</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
