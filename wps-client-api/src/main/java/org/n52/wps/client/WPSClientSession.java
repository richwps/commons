...
import net.opengis.wps.x100.impl.DeployProcessDocumentImpl;
...
public class WPSClientSession {
     ...
     * @throws WPSClientException
     */
    public boolean connectTransactional(String url) throws WPSClientException {
        LOGGER.info("CONNECT TRANSACTIONAL");

        if (this.loggedTransactionalServices.containsKey(url)) {
            LOGGER.info("Service already registered: " + url);
            return false;
        }
        ...
        try {
            ...
            LOGGER.info("Unable to reach service: " + url);
            return false;
        }

        loggedTransactionalServices.put(url, url);
        return true;
    }
     ...
     * @param url
     */
    public void disconnectTransactional(String url) {
    ...
    /**
     * returns the serverIDs of all loggedTransactionaleServices
     *
     * @return
     */
    public List<String> getLoggedTransactionalServices() {
        return new ArrayList<String>(this.loggedTransactionalServices.keySet());
    }
